...
export type ProductDetailsFragment_ProductFragment = { name: string, sku: string, id: string, isVariantOf: { name: string }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { offers: Array<{ price: number, listPrice: number, seller: { identifier: string } }> } };
