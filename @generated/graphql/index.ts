...
export type CollectionPageQueryQuery = { site: { siteMetadata: { titleTemplate: string | null | undefined, title: string | null | undefined, description: string | null | undefined } | null | undefined } | null | undefined };
...
export type ServerCollectionPageQueryQuery = { collection: { seo: { title: string, description: string }, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, meta: { selectedFacets: Array<{ key: string, value: string }> } }, allProducts: { edges: Array<{ node: { slug: string, sku: string, name: string, gtin: string, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, quantity: number, seller: { identifier: string } }> } } }> } };

export type ProductPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductPageQueryQuery = { site: { siteMetadata: { title: string | null | undefined, description: string | null | undefined, titleTemplate: string | null | undefined, siteUrl: string | null | undefined } | null | undefined } | null | undefined };
...
export type ServerProductPageQueryQuery = { product: { slug: string, sku: string, gtin: string, name: string, description: string, id: string, seo: { title: string, description: string }, brand: { name: string }, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, highPrice: number, priceCurrency: string, offers: Array<{ availability: string, price: number, priceValidUntil: string, priceCurrency: string, itemCondition: string, listPrice: number, seller: { identifier: string } }> }, isVariantOf: { productGroupID: string, name: string } }, allProducts: { edges: Array<{ node: { slug: string, sku: string, name: string, gtin: string, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, quantity: number, seller: { identifier: string } }> } } }> } };

export type HomePageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type HomePageQueryQuery = { site: { siteMetadata: { title: string | null | undefined, description: string | null | undefined, titleTemplate: string | null | undefined } | null | undefined } | null | undefined };

export type ServerHomePageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ServerHomePageQueryQuery = { allProducts: { edges: Array<{ node: { slug: string, sku: string, name: string, gtin: string, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, quantity: number, seller: { identifier: string } }> } } }> } };

export type SearchPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SearchPageQueryQuery = { site: { siteMetadata: { titleTemplate: string | null | undefined, title: string | null | undefined, description: string | null | undefined } | null | undefined } | null | undefined };
